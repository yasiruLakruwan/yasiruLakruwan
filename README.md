...
Deep learning–based system that converts audio into spectrograms and predicts music genres using CNNs.

### 📚 **Knowledge-Based RAG System**
A production-ready Retrieval-Augmented Generation pipeline with embeddings, chunking, vector DBs, and LLM orchestration.
